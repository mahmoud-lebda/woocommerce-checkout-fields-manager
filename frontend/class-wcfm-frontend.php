...
class WCFM_Frontend {
    ...
    public function enqueue_scripts() {
        if (is_checkout() || is_wc_endpoint_url('order-pay')) {
            ...
            wp_localize_script('wcfm-frontend', 'wcfm_frontend', array(
                'ajax_url' => admin_url('admin-ajax.php'),
                'nonce' => wp_create_nonce('wcfm_frontend_nonce'),
                'is_block_checkout' => has_block('woocommerce/checkout'),
                'field_settings' => $this->get_frontend_field_settings(),
                'strings' => array(
                    ...
                    'field_too_short' => __('This field is too short.', WCFM_TEXT_DOMAIN),
                    'field_too_long' => __('This field is too long.', WCFM_TEXT_DOMAIN),
                ),
            ));
        }
    }
